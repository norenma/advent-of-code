 ...
 */
class Day2KtTest {
    val input = "179\t2358\t5197\t867\t163\t4418\t3135\t5049\t187\t166\t4682\t5080\t5541\t172\t4294\t1397\n" +
    ...
    @Test
    fun testGetCheckSum() {
        print(getCheckSum(formatString(input)))
    }

    @Test
    fun testGetEvenForRow() {
        print(getEvenDivisibleRow(listOf(5,9,2,8)))
    }

    @Test
    fun testGetEvenFor() {
        print(getEvenDivisible(formatString(input)))
    }
